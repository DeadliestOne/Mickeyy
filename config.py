...
SUPPORT_GRP = getenv("SUPPORT_GRP", "BeAkatsuki")
UPDATE_CHNL = getenv("UPDATE_CHNL", "ThunderboltFantasy")
...
# Random Stickers
STICKER = [
    "CAACAgQAAxkBAAIQMGcHxKzA0v7Pw03F3Ds0K6ofVzCCAAIVDAAC1SMQU-QrCHEcbz8rHgQ",
    "CAACAgQAAxkBAAIQL2cHxKmBSFE0jviZmePV0LLmvQeEAALAEQACpvFxHgbA0g9MDZWfHgQ",
    "CAACAgQAAxkBAAIQLmcHxKZO1xKgdEma1gABAjJSNdKOcQACNRUAAt6KoFFwQBbrLqrCox4E",
]
